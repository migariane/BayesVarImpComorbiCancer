---
title: "Colorectal cancer: Early Stages"
...
ind.early <- which(survdatac$stage< 4)
...
data_plot_names
data_plot_names <- c("Hemiplegia" , "Connective disease", "Diabetes", "Infarct",
                     "Gender", "Liver disease", "Renal disease", "Dementia",
                     "Vascular disease", "Heart failure", "Cerebrovascular disease", "Pulmonary disease",
                     "Age") # Fix labels
data_plot_names
